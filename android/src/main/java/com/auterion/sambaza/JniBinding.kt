...
class JniBinding {
  companion object {
     ...
     */
    init {
      //System.loadLibrary("gstreamer_android") //this doesn't exist now
      System.loadLibrary("sambaza")
      nativeClassInit()

//TODO GStreamer class seems to somehow be autogenerated
// Two real options here:
// - Initialize this as a non-companion/static object
// - move relevant C code into our native lib
//      // Initialize GStreamer and warn if it fails
//      try {
//        GStreamer.init(DSApplication.Instance)
//      } catch (e: Exception) {}
